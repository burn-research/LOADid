...
plt.savefig(os.path.join(BASE_DIR, f'../../Figures/MLP/training_loss_evolution_gas.png'), dpi=300, bbox_inches='tight')
plt.savefig(os.path.join(BASE_DIR, f'../../Figures/MLP/training_loss_evolution_gas.pdf'), bbox_inches='tight')

plt.show()

#%% Result analysis

for group, df_group in df_results.groupby('METER_TYPE'):
